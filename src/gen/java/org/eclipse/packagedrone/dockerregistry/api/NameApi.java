...
import org.eclipse.packagedrone.dockerregistry.api.factories.NameApiServiceFactory;

import io.swagger.annotations.ApiParam;

import org.eclipse.packagedrone.dockerregistry.models.InlineResponse200;
...
public class NameApi  {
   private final NameApiService delegate = NameApiServiceFactory.getNameApi();
    ...
    public Response nameBlobsDigestGet(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "Digest of a desired BLOB",required=true) @PathParam("digest") String digest,@Context SecurityContext securityContext)
    ...
    public Response nameBlobsDigestHead(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "Digest of a desired BLOB",required=true) @PathParam("digest") String digest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameBlobsUploadsUuidDelete(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A uuid identifying the upload.",required=true) @PathParam("uuid") String uuid,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameBlobsUploadsUuidGet(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A uuid identifying the upload.",required=true) @PathParam("uuid") String uuid,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameBlobsUploadsUuidPatch(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A uuid identifying the upload.",required=true) @PathParam("uuid") String uuid,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "The upload is unknown to the registry. The upload must be restarted.", response = void.class) })
    public Response nameBlobsUploadsUuidPut(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A uuid identifying the upload.",required=true) @PathParam("uuid") String uuid,@ApiParam(value = "Digest of uploaded blob. If present, the upload will be completed, in a single request, with contents of the request body as the resulting blob.",required=true) @QueryParam("digest") String digest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameManifestsReferenceDelete(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A tag or a digest, pointing to a specific image",required=true) @PathParam("reference") String reference,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameManifestsReferenceGet(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A tag or a digest, pointing to a specific image",required=true) @PathParam("reference") String reference,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 401, message = "Unauthorized access", response = void.class) })
    public Response nameManifestsReferencePut(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@ApiParam(value = "A tag or a digest, pointing to a specific image",required=true) @PathParam("reference") String reference,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response nameTagsListGet(@ApiParam(value = "Name of the image (including the namespace)",required=true) @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
